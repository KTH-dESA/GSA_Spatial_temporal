...
#######################
    ...
    #pathfinder_main(path,proj_path, elec_shp, tofolder, tiffile, crs, path_polygon, spatial)
    ...
    #distribution_length_cell_ref = 'run/scenarios/distribution.csv'
    ...
    #Location file
    gisfile_ref = GIS_file(scenariopath, point)
