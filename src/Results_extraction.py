...
def main(folder, masterdata):
    ...
    run_morris(totaldiscountedcost, '%ssensitivity/sample_morris.csv' %(country), '%ssensitivity/sample_morris_nominal.csv' %(country), 'config/%sparameters.csv'%(country), '%ssensitivity/Total discounted cost %s'%(country, country), '\$', True)
    run_morris(capitalinvestment, '%ssensitivity/sample_morris.csv'%(country), '%ssensitivity/sample_morris_nominal.csv' %(country),'config/%sparameters.csv'%(country), '%ssensitivity/Capital investment %s'%(country, country), '\$', True)
    run_morris(transmcap, '%ssensitivity/sample_morris.csv'%(country),'%ssensitivity/sample_morris_nominal.csv' %(country), 'config/%sparameters.csv'%(country), '%ssensitivity/Expansion of transmission %s'%(country, country), 'kW', True)
    run_morris(RET_share, '%ssensitivity/sample_morris.csv'%(country), '%ssensitivity/sample_morris_nominal.csv' %(country),'config/%sparameters.csv'%(country), '%ssensitivity/Renewable energy production share %s'%(country, country), '%', True)
    run_morris(km, '%ssensitivity/sample_morris.csv'%(country),'%ssensitivity/sample_morris_nominal.csv' %(country), 'config/%sparameters.csv'%(country), '%ssensitivity/number of km distributionlines %s'%(country, country), 'km', True) 
    run_morris(PV_share, '%ssensitivity/sample_morris.csv'%(country),'%ssensitivity/sample_morris_nominal.csv' %(country), 'config/%sparameters.csv'%(country), '%ssensitivity/PV panel share %s'%(country, country), '%', True)

    run_morris(totaldiscountedcost, '%ssensitivity/sample_morris.csv' %(country), '%ssensitivity/sample_morris_nominal.csv' %(country), 'config/%sparameters.csv'%(country), '%ssensitivity/Total discounted cost unscaled %s'%(country, country), '\$')
    run_morris(capitalinvestment, '%ssensitivity/sample_morris.csv'%(country), '%ssensitivity/sample_morris_nominal.csv' %(country),'config/%sparameters.csv'%(country), '%ssensitivity/Capital investment unscaled %s'%(country, country), '\$')
    run_morris(transmcap, '%ssensitivity/sample_morris.csv'%(country),'%ssensitivity/sample_morris_nominal.csv' %(country), 'config/%sparameters.csv'%(country), '%ssensitivity/Expansion of transmission unscaled %s'%(country, country), 'kW')
    run_morris(RET_share, '%ssensitivity/sample_morris.csv'%(country), '%ssensitivity/sample_morris_nominal.csv' %(country),'config/%sparameters.csv'%(country), '%ssensitivity/Renewable energy production share unscaled %s'%(country, country), '%')
    run_morris(km, '%ssensitivity/sample_morris.csv'%(country),'%ssensitivity/sample_morris_nominal.csv' %(country), 'config/%sparameters.csv'%(country), '%ssensitivity/number of km distributionlines unscaled %s'%(country, country), 'km') 
    run_morris(PV_share, '%ssensitivity/sample_morris.csv'%(country),'%ssensitivity/sample_morris_nominal.csv' %(country), 'config/%sparameters.csv'%(country), '%ssensitivity/PV panel share unscaled %s'%(country, country), '%')
